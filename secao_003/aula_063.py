...
cpfEnviado = input('Informe um CPF: ')

#cpfEnviado = '74682489070'.replace('.', '').replace('-', '').replace(' ','')
cpfEnviado = re.sub(r'[^0-9]','', cpfEnviado)

entrada_sequencial = cpfEnviado == cpfEnviado[0] * len(cpfEnviado)
